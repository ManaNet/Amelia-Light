...
public class MongoDB {
    ...
    private static final MongoClient client = MongoClients.create(MongoClientSettings.builder().applicationName("Amelia Websocket")
            .compressorList(Collections.singletonList(MongoCompressor.createZstdCompressor()))
