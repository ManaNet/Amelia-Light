...
<body>
    <div class="container">
        ...
        <div class="form">
            <h2>Want your entire server to be notified when a story<br>or user's story updates?</h2>
            ...
            <a href="#" class="button" id="submit" onclick="submit();">Submit</a>
        </div>
        <div class="love">
